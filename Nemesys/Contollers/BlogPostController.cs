    ...
    public class BlogPostController : Controller
    {
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                {
                    TotalEntries = _NemesysRepository.GetAllBlogPosts().Count(),
                    BlogPosts = _NemesysRepository
                    .GetAllBlogPosts()
        ...
        public IActionResult Details(int id)
        {
            try
            {
                var post = _NemesysRepository.GetBlogPostById(id);
                if (post == null)
                    return NotFound();
                else
                {
        ...
        public IActionResult Create([Bind("Title, Content, ImageToUpload, CategoryId")] EditBlogPostViewModel newBlogPost)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _NemesysRepository.CreateBlogPost(blogPost);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            try
            {
                var existingBlogPost = _NemesysRepository.GetBlogPostById(id);
        ...
        {
            try {
                var modelToUpdate = _NemesysRepository.GetBlogPostById(id);
                ...
                if (modelToUpdate.User.Id == currentUser.Id)
                {
                    if (ModelState.IsValid)
                    {
                        ...
                        _NemesysRepository.UpdateBlogPost(modelToUpdate);
        ...
        public IActionResult Dashboard()
        {
            try
            {
                ...
                model.TotalEntries = _NemesysRepository.GetAllBlogPosts().Count();
